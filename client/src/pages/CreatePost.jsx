    ...
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-2">Share an opportunity with the campus community</p>
        </div>
        ...
        <form onSubmit={(e) => handleSubmit(e, false)} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pb-8">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-slate-100 text-slate-700 rounded-xl hover:bg-slate-200 transition-all font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Save as Draft
            </button>
            <button
