                          ...
                          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-xl">
                            <div className="flex items-center justify-between gap-4">
                              <div className="flex items-center gap-2">
                                <span className="flex items-center gap-1.5 px-2 py-1 bg-green-100 text-green-700 rounded-lg text-sm font-medium">
                            ...
                            {app.interview.notes && (
                              <p className="mt-2 text-sm text-slate-600">
                                <span className="font-medium">Note:</span> {app.interview.notes}
                              </p>
                            )}
                          </div>
                        )}
                        {app.interview?.status === 'completed' && (
                          <div className="mt-4 p-3 bg-slate-50 border border-slate-200 rounded-xl">
                            <div className="flex items-center gap-2 text-sm text-slate-600">
                              ...
                              Interview completed on {formatInterviewDate(app.interview.scheduledAt)}
                            </div>
                          </div>
                        )}
                      </div>
